(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["colorPicker"] = factory();
  else
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Palette.prototype._toggleEvent = function (toBind) {
          ...
          hexTextBox = container.querySelector(
            "." + options.cssPrefix + "palette-hex",
            container
          );
        ...
        Palette.prototype.render = function (color) {
          ...
          html = tmpl({
            ...
            getItemClass: function (itemColor) {
              return !itemColor
                ? " " + options.cssPrefix + "color-transparent"
                : "";
            },
            isSelected: function (itemColor) {
              return itemColor === color
                ? " " + options.cssPrefix + "selected"
                : "";
            },
          });
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function Slider(options, container) {
          container = domUtil.appendHTMLElement(
            "div",
            container,
            options.cssPrefix + "slider-container"
          );
        ...
        Slider.prototype.render = function (colorStr) {
          ...
          this.container.innerHTML = html;
          this.sliderSvgElement = container.querySelector(
            "." + options.cssPrefix + "svg-slider"
          );
          this.huebarSvgElement = container.querySelector(
            "." + options.cssPrefix + "svg-huebar"
          );
          this.sliderHandleElement = container.querySelector(
            "." + options.cssPrefix + "slider-handle"
          );
          this.huebarHandleElement = container.querySelector(
            "." + options.cssPrefix + "huebar-handle"
          );
          this.baseColorElement = container.querySelector(
            "." + options.cssPrefix + "slider-basecolor"
          );
        ...
        Slider.prototype._moveColorSliderHandle = function (
          newLeft,
          newTop,
          silent
        ) {
        ...
        Slider.prototype.moveSaturationAndValue = function (
          saturation,
          value,
          silent
        ) {
        ...
        Slider.prototype._prepareColorSliderForMouseEvent = function (event) {
          var options = this.options;
          var sliderPart = closest(
            event.target,
            "." + options.cssPrefix + "slider-part"
          );
          var cache;
          cache = this._dragDataCache = {
            isColorSlider: hasClass(
              sliderPart,
              options.cssPrefix + "slider-left"
            ),
        ...
        var svgvml = {
          ...
          setTranslateY: function (obj, y) {
            if (isOldBrowser) {
              ...
              obj.setAttribute(
                "transform",
                "translate(" + SVG_HUE_HANDLE_RIGHT_POS + "," + y + ")"
              );
            }
          },
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        ColorPicker.prototype._onSelectColorInPalette = function (
          selectColorEventData
        ) {
        ...
        ColorPicker.prototype._onSelectColorInSlider = function (
          selectColorEventData
        ) {
          var color = selectColorEventData.color;
          var opt = this.options;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function extractElseif(ifExps, sourcesInsideBlock) {
          ...
          forEach(sourcesInsideBlock, function (source, index) {
            if (source.indexOf("if") === 0) {
              ...
              exps.push(
                source === "else" ? ["true"] : source.split(" ").slice(1)
              );
        ...
        function handleWith(exps, sourcesInsideBlock, context) {
          ...
          return (
            compile(sourcesInsideBlock, extend(context, additionalContext)) ||
            ""
          );
        }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        /* WEBPACK VAR INJECTION */ (function (global) {
          ...
          if (isOldBrowser) {
            global.document.namespaces.add(
              "v",
